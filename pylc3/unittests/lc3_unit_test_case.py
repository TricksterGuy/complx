...
class LC3UnitTestCase(unittest.TestCase):
    ...
    def fillValue(self, address, value):
        ...
        *NOTICE* It is an error to call this function on an labeled address, the reasoning for this is that there is
        ...
        Args:
            ...
            value: Integer - Value to write at that address
        """
        self._internalAssert('fillValue', not self._asm_filename, 'Attempt to fill a memory address before student program was loaded', AssertionType.fatal, internal=True)
    ...
    def fillString(self, address, text):
        ...
        *NOTICE* It is an error to call this function on an labeled address, the reasoning for this is that there is
        ...
        """
        self._internalAssert('fillString', not self._asm_filename, 'Attempt to fill a memory address before student program was loaded', AssertionType.fatal, internal=True)
    ...
    def fillArray(self, address, arr):
        ...
        *NOTICE* It is an error to call this function on an labeled address, the reasoning for this is that there is
        ...
        self._internalAssert('fillArray', not self._asm_filename, 'Attempt to fill a memory address before student program was loaded', AssertionType.fatal, internal=True)
    ...
    def fillNode(self, address, next, data):
        ...
        *NOTICE* It is an error to call this function on an labeled address.
        ...
        self._internalAssert('fillNode', not self._asm_filename, 'Attempt to fill a memory address before student program was loaded', AssertionType.fatal, internal=True)
