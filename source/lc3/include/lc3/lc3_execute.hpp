...
/** lc3_setcc
  ...
  */
void LC3_API lc3_setcc(lc3_state& state, short value);
/** lc3_mem_read
  *
  * Reads from memory.
  * @param state LC3State object.
  ...
  */
short LC3_API lc3_mem_read(lc3_state& state, unsigned short addr, bool privileged = false);
/** lc3_mem_write
  *
  * Writes to memory.
  * @param state LC3State object.
  ...
  */
void LC3_API lc3_mem_write(lc3_state& state, unsigned short addr, short val, bool privileged = false);
/** lc3_warning
  *
  ...
  */
void LC3_API lc3_warning(lc3_state& state, unsigned int warn_id, short arg1, short arg2);
/** lc3_warning
  *
  ...
  */
void LC3_API lc3_warning(lc3_state& state, const std::string& warning);
