...
BWLCDGUI::BWLCDGUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, int64_t style ) : wxDialog( parent, id, title, pos, size, style )
{
