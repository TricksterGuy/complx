...
{
    wxFileName manual(_(XSTR(PREFIX) "/share/complx-tools/Complx.pdf"));
    manual.Normalize();
...
{
    wxFileName manual(_(XSTR(PREFIX) "/share/complx-tools/PattPatelAppA.pdf"));
    manual.Normalize();
    wxLaunchDefaultBrowser(manual.GetFullPath());
}
...
{
    wxFileName manual(_(XSTR(PREFIX) "/share/complx-tools/ComplxChangeLog.txt"));
    manual.Normalize();
    wxLaunchDefaultBrowser(manual.GetFullPath());
}
