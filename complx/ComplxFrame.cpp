...
{
    wxFileName manual(_("PREFIX/share/complx-tools/Complx.pdf"));
    manual.Normalize();
...
{
    wxFileName manual(_("PREFIX/share/complx-tools/PattPatelAppA.pdf"));
    manual.Normalize();
    wxLaunchDefaultBrowser(manual.GetFullPath());
}
...
{
    wxFileName manual(_("PREFIX/share/complx-tools/ComplxChangeLog.txt"));
    manual.Normalize();
    wxLaunchDefaultBrowser(manual.GetFullPath());
}
