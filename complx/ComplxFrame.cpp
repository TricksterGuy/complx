...
{
    wxFileName manual(_("/usr/share/complx-tools/Complx.pdf"));
    manual.Normalize();
...
{
    wxFileName manual(_("/usr/share/complx-tools/PattPatelAppA.pdf"));
    manual.Normalize();
    wxLaunchDefaultBrowser(manual.GetFullPath());
}
...
{
    wxFileName manual(_("/usr/share/complx-tools/ComplxChangeLog.txt"));
    manual.Normalize();
    wxLaunchDefaultBrowser(manual.GetFullPath());
}
...
void ComplxFrame::OnTips(wxCommandEvent& event)
{
    ...
    wxTipProvider* tip = wxCreateFileTipProvider("/usr/share/complx-tools/complx-tips.txt", currentTip);
