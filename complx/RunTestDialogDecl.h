...
protected:
    ...
    virtual void OnSelectTestItem( wxTreeEvent& event )
    {
        event.Skip();
    }
    virtual void OnTestReport( wxCommandEvent& event )
    {
        event.Skip();
    }
    ...
    virtual void OnRunTest( wxCommandEvent& event )
    {
        event.Skip();
    }
    virtual void OnRunTests( wxCommandEvent& event )
    {
        event.Skip();
    }
